        ...
        <div className='hero-section' id="contact">
            <Row className="d-flex justify-content-center">
                <Col md={4} className='d-flex flex-column align-self-center'>
                    ...
                    <a className="contact-link" href="mailto:weeroyce@gmail.com" target="_blank" rel="noopener noreferrer"><MdEmail/> weeroyce@gmail.com</a>
                    <a className="contact-link"><FaPhone/> 778-325-0325</a>
                    <a className="contact-link" href="https://drive.google.com/file/d/16Nlf7HWGnnYuCLxXwdwHfWqgCT3YbvOG/view?usp=sharing" target="_blank" rel="noopener noreferrer"><MdOutlineWysiwyg/> Get my resume</a>
